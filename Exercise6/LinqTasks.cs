...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            bool result = Emps.Select(e => e.Job).Contains("Backend programmer");
            return result;
        }
        ...
        public static IEnumerable<object> Task10()
        {
            IEnumerable<object> result = 
                Emps.Select(e => new{Ename = e.Ename, Job = e.Job, HireDate = e.HireDate}).Union(new []
        ...
        public static IEnumerable<object> Task11()
        {
            ...
            //Emps.GroupBy(e => e.Deptno).Select(e => new{name = e.Key, numOfEmployees = e.Count()});;
            return result;
        }
        ...
        {
            IEnumerable<Emp> result = CustomExtensionMethods.GetWorkers(Emps);
            return result;
        }
        ...
        {
            int result = CustomExtensionMethods.FindOdd(arr);
            return result;
        }
        ...
        {
            IEnumerable<Dept> result = Depts.Where(dept => !Emps.Any(emp => emp.Deptno == dept.Deptno) || Emps.Count(emp => emp.Deptno == dept.Deptno) == 5).OrderBy(dept => dept.Dname);
            return result;
        }
    }
    ...
    public static class CustomExtensionMethods
    {
        /// Metoda powinna zwrócić tylko tych pracowników, którzy mają min. 1 bezpośredniego podwładnego.
        /// Pracownicy powinny w ramach kolekcji być posortowani po nazwisku (rosnąco) i pensji (malejąco).
        public static IEnumerable<Emp> GetWorkers(IEnumerable<Emp> Emps)
        {
            IEnumerable<Emp> managers = Emps.Where(e => e.Mgr is not null).Select(e => e.Mgr);

            return managers.OrderBy(e => e.Ename).ThenByDescending(e => e.Salary);
        }
        ...
        {
            int result = arr.GroupBy(e => e).Select(e => new{Val = e.Key, Amm = e.Count()}).Where(e => e.Amm %2 == 1).First().Val;
            return result;
        }
    }
}